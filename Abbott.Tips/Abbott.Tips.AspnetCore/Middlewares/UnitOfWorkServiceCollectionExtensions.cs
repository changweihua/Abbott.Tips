...
namespace Abbott.Tips.AspnetCore.Middlewares
{
    ...
    public static class UnitOfWorkServiceCollectionExtensions
    {
        ...
        {
            services.AddScoped<IEntityRepositoryFactory, UnitOfWork<TContext>>();
            ...
            services.AddScoped<IGenericUnitOfWork<TContext>, UnitOfWork<TContext>>();
        ...
        {
            services.AddScoped<IGenericUnitOfWork<TContext1>, UnitOfWork<TContext1>>();
            services.AddScoped<IGenericUnitOfWork<TContext2>, UnitOfWork<TContext2>>();
            ...
            where TContext3 : DbContext
        {
            services.AddScoped<IGenericUnitOfWork<TContext1>, UnitOfWork<TContext1>>();
            services.AddScoped<IGenericUnitOfWork<TContext2>, UnitOfWork<TContext2>>();
            services.AddScoped<IGenericUnitOfWork<TContext3>, UnitOfWork<TContext3>>();
            ...
            where TContext4 : DbContext
        {
            ...
            services.AddScoped<IGenericUnitOfWork<TContext2>, UnitOfWork<TContext2>>();
            services.AddScoped<IGenericUnitOfWork<TContext3>, UnitOfWork<TContext3>>();
            services.AddScoped<IGenericUnitOfWork<TContext4>, UnitOfWork<TContext4>>();
